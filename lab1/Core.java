...
//            }
                    ...
                    switch (OC) {
                        case "START": {
                            ...
                            if (!flagStart) {
                                ...
                                if (countAddress == 0) {
                                    errorText = "В строке " + (i + 1) + " ошибка. Адрес начала программы должен быть не равен нулю";
                                    return false;
                                }
                                if (mark.isEmpty()) {
    ...
    public boolean doSecondPass(JTextArea BC, int typeAdr) {
        errorText = "";
        ...
        for (int i = 0; i < supportTable.get(0).size(); i++) {
            ...
            if (i == 0) {
                System.out.println(address + " " + OC + " " + OP1 + OP2);
