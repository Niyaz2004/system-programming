...
//    private final JComboBox<String> addressingModeComboBox;
    ...
    public MainWindow() {
        ...
        label2.setBounds(90, 375, 200, 20);
        group1.add(label2);
        ...
        scrollOp.setBounds(60, 395, 210, 180);
        group1.add(scrollOp);

        JButton addOpButton = new JButton("Добавить команду");
        addOpButton.setBounds(60, 580, 80, 30);
        ...
        scrollSym.setBounds(5, 270, 315, 150);
...
//        group2.add(labelSetting);
        ...
        firstPassButton.setBounds(170, 640, 200, 40);
        add(firstPassButton);
...
//        add(addressingModeComboBox);
        ...
        deleteOpButton.setBounds(150, 580, 80, 30); // разместить под кнопкой добавления
...
//        ((DefaultTableModel) settingTable.getModel()).setRowCount(0);
    ...
    private void performSecondPass() {
        ...
        boolean success = core.doSecondPass(binaryCodeTextBox, typeAdr);
